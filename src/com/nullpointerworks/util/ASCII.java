...
public class ASCII
{
	...
	public final static int BACKSPACE	= 8; // BS
	public final static int TAB 		= 9; // HT
	...
	public final static int SHIFT 		= 16; // DLE
	public final static int CTRL 		= 17; // DC1
	public final static int ALT 		= 18; // DC2
	public final static int PAUSE 		= 19; // DC3
	...
	public final static int CIRCUMFLEX 	= 94; // caret
	public final static int UNDERSCORE 	= 95; // understrike
	...
	public final static int p = 112; // F1
	public final static int q = 113; // F2
	public final static int r = 114; // F3
	public final static int s = 115; // F4
	public final static int t = 116; // F5
	public final static int u = 117; // F6
	public final static int v = 118; // F7
	public final static int w = 119; // F8
	public final static int x = 120; // F9
	public final static int y = 121; // F10
